...
class Maze:
    ...
    reward_exit = 10.0
    penalty_move = -0.05
    penalty_visited = -0.25 # penalty for returning to an already visited cell
    penalty_impossible_move = -0.75 #penalty for trying to enter an occupied cell or through a wall
